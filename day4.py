...
# you end up with 1 instance of card 1, 2 instances of card 2, 4 instances of card 3, 8 instances of card 4,
# 14 instances of card 5, and 1 instance of card 6. In total, this example pile of scratchcards causes
