...
def test_day10():
    assert day10.part1("input/day10_tiny1.txt") == 8
    assert day10.part2("input/day10_tiny1.txt") == 1

    assert day10.part1("input/day10_tiny2.txt") == 23
    assert day10.part2("input/day10_tiny2.txt") == 4
